    ...
    <Layout>
      ...
      <section className="py-16 sm:py-24 md:py-36 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="grid grid-cols-12 gap-12 md:gap-6 max-w-6xl mx-auto mt-12 md:mt-16">
            {projects.slice(0, 4).map((project, i) => {
              ...
              const aspect = isTall ? "aspect-[4/5] md:aspect-[4/5]" : "aspect-[4/5] md:aspect-[3/4]";
                ...
                <ScrollReveal key={project.slug} delay={i * 0.08}>
                  <div className={`col-span-12 ${colSpan}`}>
                    <Link to={`/portfolio/${project.slug}`} className="group block relative">
                      {/* Index watermark */}
                      <div className="absolute -top-6 -left-1 md:-top-4 md:-left-2 z-20 pointer-events-none">
