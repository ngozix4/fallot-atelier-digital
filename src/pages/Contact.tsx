    ...
    <Layout>
      <section className="relative pt-32 pb-20 md:pt-44 md:pb-36 overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-3xl">
          <ScrollReveal>
            <p className="text-caption text-accent mb-6 md:mb-8 text-center">GET IN TOUCH</p>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            <h1 className="heading-display text-foreground mb-6 md:mb-8 text-center">Contact</h1>
          </ScrollReveal>
          <ScrollReveal delay={0.15}>
            <p className="text-editorial text-muted-foreground text-center mb-12 md:mb-16 max-w-xl mx-auto">
